class Message {
  ...
  _getContentBox() {
    return (
      document.getElementById(this._contentBoxId) ||
      (() => {
  ...
  /**
   * @description: Reset parent element height
   */
  _setContentBoxTop() {
    const contentBox = document.getElementById(this._contentBoxId);
    if (contentBox) {
